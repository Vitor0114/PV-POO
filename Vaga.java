...
public class Vaga {
    ...
    private int id;
    private Generic<String, Integer> vaga;
    private String tipo;
    private String tamanho;
    private double preco;
    public static ArrayList<Vaga> vagas = new ArrayList<Vaga>();

    public Vaga(int id, Generic<String, Integer> vaga, String tipo, String tamanho, double preco) {
    ...
    public Generic<String, Integer>  getVaga() {
        return this.vaga;
    }

    public void setVaga(Generic<String, Integer> vaga) {
        this.vaga = vaga;
    }
    ...
    public Boolean verificaVaga(Generic<String, Integer> vaga){
